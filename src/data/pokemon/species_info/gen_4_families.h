...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_SHELL_ARMOR : ABILITY_OVERGROW, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_ROCK_HEAD : ABILITY_NONE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_OVERGROW : ABILITY_SHELL_ARMOR },
    ...
    [SPECIES_TORTERRA] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_CUSTOM ? 100 : 95,
        .baseAttack    = 109,
        .baseDefense   = 105,
        .baseSpeed     = 56,
        .baseSpAttack  = 75,
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_IRON_FIST : ABILITY_BLAZE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_INNER_FOCUS : ABILITY_NONE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_BLAZE : ABILITY_IRON_FIST },
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_DEFIANT, ABILITY_COMPETITIVE, ABILITY_TORRENT },
    ...
    [SPECIES_BIDOOF] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_FIELD),
        .abilities = { ABILITY_SIMPLE, ABILITY_UNAWARE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_OVERCOAT : ABILITY_MOODY },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_KRICKETOT] =
    {
        ...
        .abilities = { ABILITY_SHED_SKIN, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_SOUNDPROOF : ABILITY_NONE, ABILITY_RUN_AWAY },
    ...
    [SPECIES_KRICKETUNE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SWARM, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_SOUNDPROOF : ABILITY_NONE, ABILITY_TECHNICIAN },
        .bodyColor = BODY_COLOR_RED,
    ...
    [SPECIES_LUXIO] =
    {
        ...
        .baseAttack    = 85,
        .baseDefense   = 49,
        .baseSpeed     = P_UPDATED_STATS >= GEN_CUSTOM ? 70 : 60,
        .baseSpAttack  = 60,
        .baseSpDefense = 49,
        .types = MON_TYPES(TYPE_ELECTRIC),
        .catchRate = 120,
    ...
    [SPECIES_LUXRAY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_DAZZLING : ABILITY_RIVALRY, ABILITY_INTIMIDATE, ABILITY_GUTS },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CRANIDOS] =
    {
        ...
        .abilities = { ABILITY_MOLD_BREAKER, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_UNAWARE : ABILITY_NONE, ABILITY_SHEER_FORCE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_SHIELDON] =
    {
        ...
        .growthRate = GROWTH_ERRATIC,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER),
        .abilities = { ABILITY_STURDY, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_DAUNTLESS_SHIELD : ABILITY_NONE, ABILITY_SOUNDPROOF },
    ...
    [SPECIES_WORMADAM_PLANT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_SAP_SIPPER : ABILITY_ANTICIPATION, ABILITY_NONE, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_WORMADAM_SANDY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_EARTH_EATER : ABILITY_ANTICIPATION, ABILITY_NONE, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
    ...
    [SPECIES_WORMADAM_TRASH] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_FILTER : ABILITY_ANTICIPATION, ABILITY_NONE, ABILITY_OVERCOAT },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Wormadam"),
        .cryId = CRY_WORMADAM,
        .natDexNum = NATIONAL_DEX_WORMADAM,
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_VESPIQUEN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_QUEENLY_MAJESTY : ABILITY_PRESSURE, ABILITY_NONE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CHERRIM_SUNSHINE] =
    {
        ...
        .baseSpAttack  = P_UPDATED_STATS >= GEN_CUSTOM ? 117 : 87,
        .baseSpDefense = P_UPDATED_STATS >= GEN_CUSTOM ? 118 : 78,
        .types = MON_TYPES(TYPE_GRASS),
        .catchRate = 75,
        .expYield = (P_UPDATED_EXP_YIELDS >= GEN_5) ? 158 : 133,
        .evYield_SpAttack = 2,
    ...
    {
        .baseHP        = 65,
        .baseAttack    = P_UPDATED_STATS >= GEN_CUSTOM ? 106 : 76,
        .baseDefense   = 84,
        .baseSpeed     = P_UPDATED_STATS >= GEN_CUSTOM ? 115 : 105,
        .baseSpAttack  = 54,
        .baseSpDefense = 96,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_SCRAPPY : ABILITY_CUTE_CHARM, ABILITY_KLUTZ, ABILITY_LIMBER },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_STUNKY] =
    {
        ...
        .baseDefense   = 47,
        .baseSpeed     = 74,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_CUSTOM ? 61 : 41,
        .baseSpDefense = 41,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_STENCH, ABILITY_AFTERMATH, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_FLARE_BOOST : ABILITY_KEEN_EYE },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_SKUNTANK] =
    {
        ...
        .baseDefense   = 67,
        .baseSpeed     = 84,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_CUSTOM ? 101 : 71,
        .baseSpDefense = 61,
        .types = MON_TYPES(TYPE_POISON, TYPE_DARK),
        .catchRate = 60,
    ...
    [SPECIES_CHATOT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_KEEN_EYE, ABILITY_TANGLED_FEET, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_PUNK_ROCK : ABILITY_BIG_PECKS },
    ...
    [SPECIES_SPIRITOMB] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { ABILITY_PRESSURE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_INFILTRATOR : ABILITY_NONE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_INTIMIDATE : ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_PURPLE,
    ...
    [SPECIES_GIBLE] =
    {
        ...
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_SAND_FORCE : ABILITY_SAND_VEIL, ABILITY_NONE, ABILITY_ROUGH_SKIN },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Gible"),
        .cryId = CRY_GIBLE,
    ...
    [SPECIES_RIOLU] =
    {
        ...
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_ADAPTABILITY : ABILITY_STEADFAST, ABILITY_INNER_FOCUS, ABILITY_PRANKSTER },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Riolu"),
        .cryId = CRY_RIOLU,
    ...
    {
        .baseHP        = 70,
        .baseAttack    = P_UPDATED_STATS >= GEN_CUSTOM ? 115 : 110,
        .baseDefense   = 70,
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD, EGG_GROUP_HUMAN_LIKE),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_ADAPTABILITY : ABILITY_STEADFAST, ABILITY_INNER_FOCUS, ABILITY_JUSTIFIED },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_CROAGUNK] =
    {
        ...
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_SIMPLE : ABILITY_ANTICIPATION, ABILITY_DRY_SKIN, ABILITY_POISON_TOUCH },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TOXICROAK] =
    {
        ...
        .baseDefense   = 65,
        .baseSpeed     = 85,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_CUSTOM ? 106 : 86,
        .baseSpDefense = 65,
        .types = MON_TYPES(TYPE_POISON, TYPE_FIGHTING),
        .catchRate = 75,
    ...
    [SPECIES_FINNEON] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_CUSTOM ? 56 : 49,
        .baseAttack    = 49,
        .baseDefense   = 56,
        .baseSpeed     = 66,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_CUSTOM ? 66 : 49,
        .baseSpDefense = 61,
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 190,
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_STORM_DRAIN, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_DAZZLING : ABILITY_WATER_VEIL },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_LUMINEON] =
    {
        .baseHP        = P_UPDATED_STATS >= GEN_CUSTOM ? 76 : 69,
        .baseAttack    = 69,
        .baseDefense   = 76,
        .baseSpeed     = 91,
        .baseSpAttack  = P_UPDATED_STATS >= GEN_CUSTOM ? 91 : 69,
        .baseSpDefense = 86,
        .types = MON_TYPES(TYPE_WATER),
        .catchRate = 75,
    ...
    [SPECIES_ROTOM_FAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_AMORPHOUS),
        .abilities = { P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_MOTOR_DRIVE : ABILITY_LEVITATE, ABILITY_NONE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_RED,
        .speciesName = _("Rotom"),
        .cryId = CRY_ROTOM,
        .natDexNum = NATIONAL_DEX_ROTOM,
