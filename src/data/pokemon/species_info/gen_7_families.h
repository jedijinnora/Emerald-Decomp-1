...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_ROWLET] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_LONG_REACH : ABILITY_NONE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_TINTED_LENS : ABILITY_LONG_REACH },
    ...
    [SPECIES_DECIDUEYE_HISUI] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_OVERGROW, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_STAKEOUT : ABILITY_NONE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Decidueye"),
        .cryId = CRY_DECIDUEYE,
        .natDexNum = NATIONAL_DEX_DECIDUEYE,
    ...
    [SPECIES_ROCKRUFF] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_SUN_STONE, SPECIES_LYCANROC_MIDDAY},
                                ...
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_LYCANROC_MIDNIGHT}),
    },
    ...
    [SPECIES_STUFFUL] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_UNAWARE : ABILITY_KLUTZ, ABILITY_CUTE_CHARM },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_BEWEAR] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLUFFY, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_UNAWARE : ABILITY_KLUTZ, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_PINK,
    ...
    [SPECIES_SANDYGAST] =
    {
        ...
        .abilities = { ABILITY_WATER_COMPACTION, ABILITY_NONE, P_UPDATED_ABILITIES >= GEN_CUSTOM ? ABILITY_EARTH_EATER : ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_BROWN,
