static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_EVER_GRANDE_CITY - 1] = {MAP_GROUP(EVER_GRANDE_CITY), MAP_NUM(EVER_GRANDE_CITY), 35, 17},
    ...
    [HEAL_LOCATION_POKEMON_LEAGUE - 1] = {MAP_GROUP(POKEMON_LEAGUE), MAP_NUM(POKEMON_LEAGUE), 18, 6},
