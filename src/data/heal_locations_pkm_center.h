...
static const struct HealLocation sHealLocationsPokemonCenter[HEAL_LOCATION_COUNT - 1] =
{
    ...
    [HEAL_LOCATION_METEOR_VILLAGE - 1] =
    {
        .group = MAP_GROUP(METEOR_VILLAGE),
        .map = MAP_NUM(METEOR_VILLAGE),
        .x = 18,
        .y = 18,
    },
    ...
    [HEAL_LOCATION_EMERALD_CAPE - 1] =
    {
        .group = MAP_GROUP(EMERALD_CAPE),
        .map = MAP_NUM(EMERALD_CAPE),
        .x = 31,
        .y = 17,
    },
