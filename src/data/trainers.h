...
#define SMART_DOUBLE_FLAGS (SMART_SWITCHING_FLAGS | AI_FLAG_HELP_PARTNER)
#define TROLL_TRAINER_FLAGS (BASIC_TRAINER_FLAGS | AI_FLAG_RISKY | AI_FLAG_PREFER_STATUS_MOVES | AI_FLAG_WILL_SUICIDE)
...
const struct Trainer gTrainers[] = {
    ...
    [TRAINER_SAMUEL] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = SMART_SWITCHING_FLAGS | AI_FLAG_OMNISCIENT,
    ...
    [TRAINER_IRVIN] =
    {
        ...
        .items = {},
        .doubleBattle = FALSE,
        .aiFlags = SMART_SWITCHING_FLAGS | AI_FLAG_SETUP_FIRST_TURN,
