...
#include "data/pokemon/level_up_learnsets/gen_custom.h" // Use customized learnset file
        ...
        case 3:
             ...
             && GetMonData(mon, MON_DATA_LEVEL, NULL) != MAX_LEVEL)
            {
                ...
                else if (param - 1 < ARRAY_COUNT(sExpCandyExperienceTable)) // EXP Candies
                {
                    ...
                    //Jinnora: I want this conditional to always succeed so Exp. Candies do not bypass caps
...
u8 GetMoveTutorMoves(struct Pokemon *mon, u16 *moves)
{
    ...
    int i, j, k;
    // i is the number of moves iterated through
    ...
    if(FlagGet(FLAG_TEACHING_EGG_MOVES)) { 
        //doing egg moves tutor
        eggSpecies = GetEggSpecies(species);
        numEggMoves = GetEggMovesBySpecies(eggSpecies, eggMoves);
        if(numEggMoves == 0) {
            return 0;
        }
        ...
        //doing standard levelup learnset tutor
