...
static const u8 sText_ItemFinderNearby[] = _("The Itemfinder's responding!\pThere's an item hidden nearby!{PAUSE_UNTIL_PRESS}");
static const u8 sText_ItemFinderOnTop[] = _("The Itemfinder's shaking wildly!{PAUSE_UNTIL_PRESS}");
