...
enum PoolRulesets {
    POOL_RULESET_BASIC,
    POOL_RULESET_DUPLICATES_ALLOWED,
...
#define MON_POOL_TAG_BADGE_0        1 << POOL_TAG_BADGE_0
#define MON_POOL_TAG_BADGE_1        1 << POOL_TAG_BADGE_1
#define MON_POOL_TAG_BADGE_2        1 << POOL_TAG_BADGE_2
#define MON_POOL_TAG_BADGE_3        1 << POOL_TAG_BADGE_3
#define MON_POOL_TAG_BADGE_4        1 << POOL_TAG_BADGE_4
#define MON_POOL_TAG_BADGE_5        1 << POOL_TAG_BADGE_5
#define MON_POOL_TAG_BADGE_6        1 << POOL_TAG_BADGE_6
#define MON_POOL_TAG_BADGE_7        1 << POOL_TAG_BADGE_7
#define MON_POOL_TAG_BADGE_8        1 << POOL_TAG_BADGE_8
