...
#define VAR_STARTER_CHOICE                               0x404E
...
#define VAR_SECRET_STASH_STATE                           0x4085 //was petalburg gym state //should be 0-4 to set stash locations
...
#define VAR_PAINTER_STATE                                0x4091 // JINNORA: Used for artist quest
