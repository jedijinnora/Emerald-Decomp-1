...
#define TRAINER_BUFFY_INITIAL               (TYPE_TUTORS_START + 3)
#define TRAINER_BUFFY_INVERSE               (TYPE_TUTORS_START + 4)
...
#define TRAINER_PERSEPHONE_INITIAL          (TYPE_TUTORS_START + 21)
#define TRAINER_PERSEPHONE_INVERSE          (TYPE_TUTORS_START + 22)
#define TRAINER_PERSEPHONE_CHALLENGE        (TYPE_TUTORS_START + 23)
#define TRAINER_HOGARTH_INITIAL             (TYPE_TUTORS_START + 24)
#define TRAINER_HOGARTH_INVERSE             (TYPE_TUTORS_START + 25)
