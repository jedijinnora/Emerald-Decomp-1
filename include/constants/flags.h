...
#define FLAG_ADDED_ITEMS_1_START                                                                0x264
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POTION           (FLAG_ADDED_ITEMS_1_START + 0x00)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_SODA_POP         (FLAG_ADDED_ITEMS_1_START + 0x01)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POKE_BALL1       (FLAG_ADDED_ITEMS_1_START + 0x02)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POKEDEX          (FLAG_ADDED_ITEMS_1_START + 0x03)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_NDEX             (FLAG_ADDED_ITEMS_1_START + 0x04)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_BAG              (FLAG_ADDED_ITEMS_1_START + 0x05)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POKE_BALL2       (FLAG_ADDED_ITEMS_1_START + 0x06)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POKEBLOCK_CASE   (FLAG_ADDED_ITEMS_1_START + 0x07)
