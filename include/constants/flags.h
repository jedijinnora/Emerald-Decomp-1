...
#define FLAG_DEFEATED_SHAYMIN                0xF2
#define FLAG_CAUGHT_SHAYMIN                  0xF3
#define FLAG_DEFEATED_MANAPHY                0xF4
#define FLAG_CAUGHT_MANAPHY                  0xF5
#define FLAG_DEFEATED_RAIKOU                 0xF6
#define FLAG_CAUGHT_RAIKOU                   0xF7
#define FLAG_DEFEATED_ENTEI                  0xF8
...
#define FLAG_MONSU_ISLAND_GREAT_TUSK         0xFE
#define FLAG_MONSU_ISLAND_SCREAM_TAIL        0xFF
#define FLAG_MONSU_ISLAND_SLITHER_WING       0x100
#define FLAG_MONSU_ISLAND_SANDY_SHOCKS       0x101
#define FLAG_MONSU_ISLAND_ROARING_MOON       0x102
#define FLAG_DEFEATED_WALKING_WAKE           0x103
#define FLAG_DEFEATED_GOUGING_FIRE           0x104
#define FLAG_DEFEATED_RAGING_BOLT            0x105
...
#define FLAG_HIDDEN_ITEM_ROUTE_113_RARE_CANDY                (FLAG_HIDDEN_ITEMS_START + 0x34)
...
#define FLAG_HIDDEN_ITEM_VERDANT_FOREST_HONEY                 0x2A3
#define FLAG_HIDDEN_ITEM_VERDANT_FOREST_RED_NECTAR            0x2A4
...
#define FLAG_DEWFORD_SNEASEL_TRADE_COMPLETED                        0x3C5
...
#define FLAG_PETALBURG_HAPPINY_TRADE_COMPLETED                      0x3CB
...
#define FLAG_ITEM_MOSSDEEP_CAVERNS_B1F_ABILITY_PATCH                0x4BD
...
#define FLAG_DEFEATED_METEOR_FALLS_STEVEN                           0x4FF // needed for vs. seeker
...
#define FLAG_LANDMARK_FLOWER_PARADISE               (SYSTEM_FLAGS + 0x85)
#define FLAG_LANDMARK_WISHMAKERS_WELL               (SYSTEM_FLAGS + 0x86)
#define FLAG_LANDMARK_SEAFOAM_COVE                  (SYSTEM_FLAGS + 0x87)
#define FLAG_LANDMARK_TITANS_GRAVE                  (SYSTEM_FLAGS + 0x88)
#define FLAG_LANDMARK_HACKERS_HIDEAWAY              (SYSTEM_FLAGS + 0x89)
#define FLAG_LANDMARK_GUARDIAN_TREE                 (SYSTEM_FLAGS + 0x8A)
#define FLAG_LANDMARK_DOMECRACY_ISLAND              (SYSTEM_FLAGS + 0x8B)
#define FLAG_LANDMARK_ANARCHY_ISLAND                (SYSTEM_FLAGS + 0x8C)
...
#define FLAG_DAILY_DEWFORD_GYM_REMATCH              (DAILY_FLAGS_START + 0x16)
#define FLAG_DAILY_MAUVILLE_GYM_REMATCH             (DAILY_FLAGS_START + 0x17)
#define FLAG_DAILY_LAVARIDGE_GYM_REMATCH            (DAILY_FLAGS_START + 0x18)
#define FLAG_DAILY_PETALBURG_GYM_REMATCH            (DAILY_FLAGS_START + 0x19)
#define FLAG_DAILY_FORTREE_GYM_REMATCH              (DAILY_FLAGS_START + 0x1A)
#define FLAG_DAILY_MOSSDEEP_GYM_REMATCH             (DAILY_FLAGS_START + 0x1B)
