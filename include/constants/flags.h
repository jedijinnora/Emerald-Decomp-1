...
#define FLAG_ITEM_ARRIVAL_FERRY_ROOM_POTION                         (FLAGS_ADDED_1_START + 0x00)
#define FLAG_ITEM_ARRIVAL_FERRY_ROOM_SUPER_POTION                   (FLAGS_ADDED_1_START + 0x01)
#define FLAG_ITEM_ARRIVAL_FERRY_ROOM_ESCAPE_ROPE                    (FLAGS_ADDED_1_START + 0x02)
#define FLAG_ITEM_ARRIVAL_FERRY_ROOM_BAG                            (FLAGS_ADDED_1_START + 0x03)
#define FLAG_HIDE_ARRIVAL_FERRY_ROOM_ROOMMATE                       (FLAGS_ADDED_1_START + 0x04)
