...
#define FLAG_HIDE_VERDANT_FOREST_PAINTER            0x25
#define FLAG_HIDE_MT_CHIMNEY_PAINTER                0x26
#define FLAG_HIDE_SOOTOPOLIS_CITY_PAINTER           0x27
#define FLAG_HIDE_MT_PYRE_PAINTER                   0x28
#define FLAG_HIDE_LAVARIDGE_TOWN_PAINTER            0x29
#define FLAG_HIDE_GRANITE_CAVE_PAINTER              0x2A
#define FLAG_HIDE_ROUTE_124_PAINTER                 0x2B
#define FLAG_HIDE_SLATEPORT_BEACH_PAINTER           0x2C
#define FLAG_HIDE_SLATEPORT_HARBOR_PAINTER          0x2D
#define FLAG_HIDE_MOSSDEEP_CITY_PAINTER             0x2E
#define FLAG_HIDE_METEOR_FALLS_PAINTER              0x2F
#define FLAG_HIDE_SKY_PILLAR_PAINTER                0x30
#define FLAG_HIDE_EVER_GRANDE_CITY_PAINTER          0x31
#define FLAG_HIDE_EMERALD_CAPE_PAINTER              0x32
...
//JINNORA: FLAGS ADDED FOR PROJECT
#define FLAGS_ADDED_1_START                                                                0x264
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POTION           (FLAGS_ADDED_1_START + 0x00)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_SODA_POP1        (FLAGS_ADDED_1_START + 0x01)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POKE_BALL1       (FLAGS_ADDED_1_START + 0x02)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POKEDEX          (FLAGS_ADDED_1_START + 0x03)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_SODA_POP2        (FLAGS_ADDED_1_START + 0x04)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_BAG              (FLAGS_ADDED_1_START + 0x05)
#define FLAG_ITEM_MOSSDEEP_CITY_ARRIVAL_FERRY_ROOM_POKE_BALL2       (FLAGS_ADDED_1_START + 0x06)
