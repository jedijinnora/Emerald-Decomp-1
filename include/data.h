...
struct TrainerMonItemCustomMovesCustomStats
{
    u16 iv;
    u8 lvl;
    u8 nature;
...
#define ITEM_CUSTOM_MOVES_CUSTOM_STATS(party) { .ItemCustomMovesCustomStats = party }, .partySize = ARRAY_COUNT(party), .partyFlags = F_TRAINER_PARTY_CUSTOM_MOVESET | F_TRAINER_PARTY_HELD_ITEM | F_TRAINER_PARTY_CUSTOM_STATS
...
union TrainerMonPtr
{
    ...
    const struct TrainerMonItemCustomMovesCustomStats *ItemCustomMovesCustomStats;
};
