...
#define P_LVL_UP_LEARNSETS          GEN_CUSTOM  // Choose which set of Level Up Learnsets to use.
                                                ...
                                                // GEN_CUSTOM: Use custom learnsets, modified from GEN_9.
...
#define P_FLAG_FORCE_SHINY      FLAG_FORCE_SHINY     // If this flag is set, all wild and gift Pokémon will be forced into being Shiny.
