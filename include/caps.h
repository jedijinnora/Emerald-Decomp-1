...
#if B_LEVEL_CAP_TYPE != LEVEL_CAP_FLAG_LIST && B_LEVEL_CAP_TYPE != LEVEL_CAP_VARIABLE && B_LEVEL_CAP_TYPE != LEVEL_CAP_CUSTOM
#error "Invalid choice for B_LEVEL_CAP_TYPE, must be of [LEVEL_CAP_FLAG_LIST, LEVEL_CAP_VARIABLE, LEVEL_CAP_CUSTOM]"
#endif
